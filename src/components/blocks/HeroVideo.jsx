      ...
      <div style={{ maxWidth: 'var(--container)', margin: '0 auto' }}>
        ...
        >
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              <div style={{ width: 28, height: 28, borderRadius: '50%', background: '#FF7A5C', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'var(--font-display)', fontSize: 11, fontWeight: 700, color: '#fff', flexShrink: 0 }}>
                {attribution.split(' ').map(w => w[0]).slice(0,2).join('')}
              </div>
              <div>
          ...
          <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, padding: isMobile ? '0 20px 16px' : '0 32px 20px', zIndex: 2 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              <span style={{ fontFamily: 'var(--font-mono)', fontSize: 9, color: 'rgba(255,255,255,0.4)', letterSpacing: 0.5, flexShrink: 0 }}>1:28</span>
              <div style={{ flex: 1, height: 3, background: 'rgba(255,255,255,0.15)', borderRadius: 99, overflow: 'hidden' }}>
                <div style={{ width: '22%', height: '100%', background: 'linear-gradient(90deg, #F4B942, #FF7A5C)', borderRadius: 99 }} />
              </div>
              <span style={{ fontFamily: 'var(--font-mono)', fontSize: 9, color: 'rgba(255,255,255,0.4)', letterSpacing: 0.5, flexShrink: 0 }}>6:42</span>
            </div>
          </div>
        </div>
      </div>
